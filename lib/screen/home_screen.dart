        ...
        child: Column(
          children: [
            ...
            CustomContainer(
              ...
              widget:
                  Image.asset("assets/images/avocado.png", fit: BoxFit.fill),
            ),
            CustomContainer(
              screenWidth: screenWidth * 0.9,
              screenHeight: screenHeight * 0.17,
            ...
            Stack(alignment: Alignment.bottomCenter,
              children: [
                CustomContainer(color: Color(0xff479DF4),
                    screenWidth: screenWidth * 0.9,
                    screenHeight: screenHeight * 0.17,
                    text:
                    "Track your Water\nConsumption\nYou are 0% there \nKeep Drinking !"),
                Container(height: screenHeight*0.2,margin: EdgeInsets.only(left: screenWidth*0.7),
