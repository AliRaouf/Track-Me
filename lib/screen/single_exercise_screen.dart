                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Text(": ${widget.exerciseList![widget.index]
                                  .bodyPart}",
                          ...
                          for (int i = 0;
                          i < widget.exerciseList![widget.index]
                              .secondaryMuscles!.length;
                          i++)
                            Text(
                                "${i + 1}) ${widget.exerciseList![widget.index]
                                    .secondaryMuscles![i]}",
                                style: GoogleFonts.itim(fontSize: 15))
                        ]),
                  ],
              ...
              Flexible(
                child: Container(
                    ...
                    child: ListView(
                      children: [
                        for (int i = 0;
                        i < widget.exerciseList![widget.index].instructions!
                            .length;
                        i++)
                          Text(
                              "${i + 1}) ${widget.exerciseList![widget.index]
